    ...
    <section className="genOffer-section" id="eventCor">
      ...
      <div className="genOffer-content">
        ...
        <div
          ...
          data-aos-delay="200"
        >
          <p className="genOffer-subtext">Groups of 4 or more enjoy a 20% discount on all packages:</p>
          <ul>
            <li>
              Pro Drive Training –{" "}
              <span className="offer-highlight">₹1,439 + GST (₹1,698 approx.)</span>
            </li>
            <li>
            ...
            <li>
              ...
              <span className="offer-highlight">₹2,639 + GST (₹3,112 approx.)</span>
            </li>
            <li>
              Adventure Value Pack (Most Popular) –{" "}
              <span className="offer-highlight">₹3,199 + GST (₹3,774 approx.)</span>
            </li>
            <li>
