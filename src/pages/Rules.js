...
const Rules = () => {
  ...
  return (
    <section className="rules-section" id="rules">
      ...
      <ol className="rules-list" data-aos="fade-up" data-aos-delay="200">
      ...
      <ul className="rules-list" data-aos="fade-up" data-aos-delay="400">
      ...
      <ul className="rules-list" data-aos="fade-up" data-aos-delay="450">
      ...
      <ul className="rules-list" data-aos="fade-up" data-aos-delay="500">
