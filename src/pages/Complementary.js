    ...
    <section className="gPackages-section" id="eventCor">
      ...
      <div className="gPackages-content">
        <h2 className="gPackages-section-title" data-aos="fade-right">
          Complimentary Experience – Free (Limited Slots)
        </h2>
        <blockquote className="gPackages-quote" data-aos="fade-up">
          “A Taste of Adventure, On Us.”
        </blockquote>
        <p className="gPackages-text" data-aos="fade-up" data-aos-delay="200">
          Get introduced to the world of off-roading with our Complimentary Experience. Enjoy a 2-lap passenger ride and feel the rush of adrenaline in just a few minutes. The perfect teaser for first-time visitors who want to experience the thrill before getting behind the wheel.
        </p>
