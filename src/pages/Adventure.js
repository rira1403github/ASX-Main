    ...
    <section className="gPackages-section" id="eventCor">
      ...
      <div className="gPackages-content">
        <h2 className="gPackages-section-title" data-aos="fade-right">
          Adventure Value Pack – ₹3,999 (in demaND)
        </h2>
        <blockquote className="gPackages-quote" data-aos="fade-up">
          “The Complete Off-Road Experience.”
        </blockquote>
        <p className="gPackages-text" data-aos="fade-up" data-aos-delay="200">
         Our best-selling package, the Adventure Value Pack, brings you the ultimate off-road journey. Over 20 thrilling minutes, conquer both Level 1 obstacles and Level 2 high-speed tracks, enjoy complimentary laps, and benefit from professional training. With self-drive + passenger combos included, it’s the most chosen ride at ASX Motodrome — perfect for adventurers who want it all in one unforgettable experience.
        </p>
      ...
      <hr className="gPackages-divider" />
