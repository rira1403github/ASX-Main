...
const FestiveOffer = () => {
  ...
  return (
    <section className="genOffer-section" id="festiveOffer">
      <div
      ...
      <div className="genOffer-content">
        ...
        >
          <p className="genOffer-subtext">
            On festive days, enjoy 15% off on all packages:
          </p>
          <ul className="genOffer-list">
            <li>
              Pro Drive Training –{" "}
              <span className="genoffer-highlight">₹849 + GST (₹1,002 approx.)</span>
            </li>
            <li>
            ...
            <li>
              ...
              <span className="genoffer-highlight">₹2,804 + GST (₹3,309 approx.)</span>
            </li>
            <li>
              Adventure Value Pack (Most Popular) –{" "}
              <span className="genoffer-highlight">₹3,399 + GST (₹4,011 approx.)</span>
            </li>
            <li>
      ...
      <div className="genOffer-experience-container" data-aos="fade-up">
        ...
        <form className="genOffer-form-container" onSubmit={handleSubmit}>
          ...
          <div className="genOffer-form-group">
            ...
            <div className="radio-group" data-aos="fade-up" data-aos-delay="600">
              {rideTypes.map((ride) => (
          ...
          <div className="genOffer-form-group">
            ...
            <div className="radio-group" data-aos="fade-up" data-aos-delay="700">
          ...
          <div className="genOffer-form-group">
            <button type="submit" className="genOffer-submit-btn" data-aos="zoom-in" data-aos-delay="800">
              CONTINUE
            </button>
          </div>
        </form>
